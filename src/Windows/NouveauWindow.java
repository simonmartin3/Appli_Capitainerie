 ...
 * @author Simon
 */
public class NouveauWindow extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NouveauWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
